          ...
          <div className="column is-12">
            <div className="columns is-multiline">
              <div className="column">
                ...
                <h5 className="subtitle is-4 is-uppercase" style={{color: "#82ca9d"}}>{StringUtils.formatPrice(300000)}</h5>
              </div>
              <div className="column">
                <ResponsiveContainer height={32}>
                  <LineChart height={32} data={
                    ...
                    <Line type="monotone" dot={false} dataKey="pv" stroke="#82ca9d" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
          ...
          <div className="column is-12">
            <div className="columns is-multiline">
              <div className="column">
                ...
                <h5 className="subtitle is-4 is-uppercase" style={{color: "#d59b9b"}}>{StringUtils.formatPrice(10205)}</h5>
              </div>
              <div className="column">
                <ResponsiveContainer height={32}>
                  <LineChart height={32} data={
                    ...
                    <Line type="monotone" dot={false} dataKey="pv" stroke="#d59b9b" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </div>
            </div>
